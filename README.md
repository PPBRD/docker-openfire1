...
This image is a fork of sdwan/openfire to keep an up-to-date version.
...
Automated builds of the image are available on [Dockerhub](https://hub.docker.com/r/sdwan/openfire) and is the recommended method of installation.

```bash
docker pull sdwan/openfire:4.8.0
```

Alternatively you can build the image yourself.

```bash
docker build -t sdwan/openfire github.com/sdwan/docker-openfire
```
